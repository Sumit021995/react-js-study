...
function App() {
  ...
  return (
      ...
      <h1 className=' fixed flex flex-wrap justify-center bottom-4 inset-x-0 px-2 text-white'>Click on Buttons to Change Color of Background</h1>
      <div className="flex flex-wrap px-3 py-2 bg-white justify-center gap-3 shadow-lg rounded-3xl">
        ...
        <button onClick={ () => setColor("pink") } className='outline-none rounded-full justify-center px-4 py-1  text-black' style={{backgroundColor:'pink'}}>Pink</button>
        ...
        <button onClick={ () => setColor('yellow') } className='outline-none rounded-full justify-center px-4 py-1  text-black' style={{backgroundColor:'yellow'}}>Yellow</button>
