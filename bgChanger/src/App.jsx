...
function App() {
  ...
  return (
      ...
      <div className="flex flex-wrap px-3 py-2 bg-white justify-center gap-3 shadow-lg rounded-3xl">
        ...
        <button onClick={ () => setColor("pink") } className='outline-none rounded-full justify-center px-4 py-1  text-white' style={{backgroundColor:'pink'}}>Pink</button>
        ...
        <button onClick={ () => setColor('yellow') } className='outline-none rounded-full justify-center px-4 py-1  text-white' style={{backgroundColor:'yellow'}}>Yellow</button>
